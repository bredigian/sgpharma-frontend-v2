...
export default async function ProductDetail({ params }: Props) {
  ...
  return (
    <div className='3xl:min-h-screen flex w-full flex-col items-center gap-12 p-8 md:flex-row md:items-start xl:mx-auto xl:gap-32 xl:p-16 2xl:min-h-[120vh] 2xl:w-[72%]'>
